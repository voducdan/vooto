...
**Summary**: Vocabulary for the IELTS 'Technology' topic, extracted from pages 162-165 of the source book.
...
- **Nouns** (14): `Computer age`, `Computer buff`, `Desktop PC`, `Gadget`, `Geek`, `Technology gadget`, `Subscriber`, `Smiley`, `Online`, `Advances in technology`, `Digital age`, `Reliance [on]`, `Innovation`, `Digital camera`
- **Verbs** (4): `To utilize`, `To back up files`, `To boot up`, `To go online`
- **Expressions** (1): `To be stuck behind a computer`
