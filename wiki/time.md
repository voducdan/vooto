...
**Summary**: Vocabulary for the IELTS 'Time' topic, extracted from pages 118-122 of the source book.
...
- **Nouns** (3): `A digital watch`, `Childhood`, `Quality time`
- **Adjectives** (9): `Timely`, `Upcoming`, `Age-old`, `Time-consuming`, `Ancient`, `Brand-new`, `Antique`, `Middle-aged`, `Contemporary`
- **Adverbs** (12): `Once in a lifetime`, `Annually`, `The coming year`, `Up to the minute`, `Punctual`, `On time`, `Right after`, `Nowadays`, `Down the road`, `Right away`, `Currently`, `In this day and age`
- **Expressions** (1): `Take your time`
