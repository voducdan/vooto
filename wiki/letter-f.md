# Letter F (Alphabetical Vocabulary)
...
- **Nouns** (2): `Faculty`, `Fierce competition`
- **Verbs** (3): `Force`, `Fool around`, `To fuel`
- **Adjectives** (3): `Fed up`, `Flawless`, `Fake`
- **Adverbs** (2): `Fortunately`, `Foremost`
- **Expressions** (6): `For good`, `Forget all about`, `From scratch`, `Fully intend to`, `To fall by the wayside`, `Far and wide`

---

## Entries

### For good *[Expression]* *(collocation)*
...
### Forget all about *[Expression]* *(collocation)*
...
### From scratch *[Expression]* *(collocation)*
...
### Fully intend to *[Expression]* *(collocation)*
...
### To fall by the wayside *[Expression]* *(collocation)*
...
### Far and wide *[Expression]* *(collocation)*
...
### Fierce competition *[Noun]* *(collocation)*
