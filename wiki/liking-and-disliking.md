...
**Summary**: Vocabulary for the IELTS 'Liking and Disliking' topic, extracted from pages 243-244 of the source book.
...
- **Verbs** (2): `To detest`, `Can't stand (someone or something)`
- **Expressions** (4): `Be keen on`, `Fond of`, `Be passionate about`, `Have a passion for`
