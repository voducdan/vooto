...
**Summary**: Vocabulary for the IELTS 'Environment, Weather, Climate Change and Pollution' topic, extracted from pages 101-111 of the source book.
...
- **Nouns** (34): `Rubbish`, `Littering`, `Waste treatment`, `Impact`, `Drizzle`, `Pollution`, `Clear sky`, `Global warming`, `Contamination`, `Degrees Celsius`, `Cloudy weather`, `Rainy weather`, `Downpour`, `Heavy snow`, `Snowstorm`, `Windy weather`, `Sunny weather`, `Sunshine`, `Changeable weather`, `Mild climate`, `Endangered species`, `Environmentally friendly`, `Exhaust fumes`, `Fossil fuels`, `Global warming`, `Greenhouse effect`, `Natural disaster`, `Toxic waste`, `Biodiversity`, `Deforestation`, `Ecosystems`, `Exhaust emissions`, `Erosion`, `Drought`
- **Verbs** (17): `Unsorted`, `Diminish`, `To throw something out`, `Freshen`, `Sparkle`, `Throw something out`, `Get rid of`, `Emit`, `To be spoiled by`, `Minimize`, `Devastates`, `Eliminate`, `To go below zero`, `To pour down`, `Contaminate`, `Discharge`, `Recycle`
- **Adjectives** (10): `Eco-friendly`, `Gloomy`, `Freezing = chilly`, `Boiling hot`, `Mild`, `Chilly`, `To be drenched (to the skin)`, `Humid`, `To become extinct`, `Contaminated`
- **Expressions** (3): `In all weathers`, `To be under threat`, `To get back to nature`
