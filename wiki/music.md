...
**Summary**: Vocabulary for the IELTS 'Music' topic, extracted from pages 147-151 of the source book.
...
- **Nouns** (19): `Concert venue`, `Classical music`, `Pop music`, `Folk music`, `Hip-hop`, `Melody = rhyme`, `Contemporary music`, `Genres of music`, `Catchy melody`, `Meaningful lyrics`, `Musical instrument`, `Hi-fi devices`, `Rock music`, `Catchy tune`, `Live music`, `Opera`, `Ringtone`, `Live concert`, `Rock band`
- **Verbs** (4): `Enrich`, `Enlighten`, `To face the music`, `To ring a bell`
- **Adjectives** (3): `Soothing`, `Melodious`, `Tuneful`
- **Expressions** (4): `Music to one's ears`, `Have a rehearsal`, `To sound like a broken record`, `To strike (hit) a false note`
