# Letter I (Alphabetical Vocabulary)

**Summary**: Alphabetical vocabulary entries starting with 'I', from the 'Other Vocabularies' section (pages 285-288).
...
- **Nouns** (4): `Individuality`, `Impact`, `Inequalities`, `Initiative`
- **Verbs** (5): `Indulge`, `(To) integrate`, `Intrigue`, `Implement`, `Immerse`
- **Adjectives** (5): `Inappropriate`, `Irreplaceable`, `Initial`, `Immeasurable`, `Intimidating`
- **Adverbs** (2): `Inevitably`, `Invariably`
- **Expressions** (8): `Illustrate one's point`, `Irrespective of`, `It's not an indication of`, `In jeopardy`, `It's no wonder`, `In bloom`, `In the vicinity of`, `In advance`

---

## Entries

### Indulge *[Verb]* — /ˌɪnˈdəɫdʒ/

**Definition**: to allow someone to enjoy something that they want or desire.

- Parents should not allow their children to indulge themselves playing computer.
- He indulges himself with many luxuries.

### Illustrate one's point *[Expression]* *(collocation)* — /ˈiləˌstreit/ /ˈwənz/ /ˈpɔɪnt/
...
### Individuality *[Noun]* — /ˌɪnˌdɪvɪdʒuˈæɫɪti/

**Definition**: uniqueness of character of a particular person.
...
### Irrespective of *[Expression]* *(collocation)* — /ˌɪɹəˈspɛktɪv/ /ɔv/
...
### (To) integrate *[Verb]* *(collocation)* — /ˈtu/ /ˈɪnəˌɡɹeɪt/
...
### It's not an indication of *[Expression]* *(collocation)* — /ˈɪts/ /nɔt/ /ˈæn/ / /ɔv/
...
### Inevitably *[Adverb]* — /in’evitəbli/

**Definition**: will happen no matter what/ unavoidably.

- Excessive drug use will inevitably lead to an addiction.
- He will inevitably hurt himself because he takes too many risks.

### In jeopardy *[Expression]* *(collocation)* — /ˈɪn/ /ˈdʒɛpɝdi/
...
### Inappropriate *[Adjective]* — /ˌɪnəˈpɹoʊpɹiɪt/

**Definition**: not suitable or proper for a particular purpose or situation.
...
**Definition**: a strong effect or influence on someone or something.
...
### Irreplaceable *[Adjective]* — /ˌɪɹəˈpɫeɪsəbəɫ/

**Definition**: impossible to be replaced.
...
### It's no wonder *[Expression]* *(collocation)* — /ˈɪts/ /ˈnoʊ/ /wʌndə/
...
### Intrigue *[Verb]* — /ˈɪntɹiɡ/

**Definition**: to make somebody very curious or interested about something.
...
### In bloom *[Expression]* *(collocation)* — /ˈɪn/ /ˈbɫum/
...
### In the vicinity of *[Expression]* *(collocation)* — /ˈɪn/ /ˈðə/ /vəˈsɪnəti/ /ɔv/
...
### Immeasurable *[Adjective]* — /ˌɪˈmɛʒɝˌæbəɫ/

**Definition**: too large, extensive or great to be measured.

- His films had an immeasurable effect on a generation of Japanese.
- The typhoon caused immeasurable damage.

### Invariably *[Adverb]* — /ˌɪnˈvɛɹiəbɫi/
...
### Implement *[Verb]* — /ˈɪmpɫəmənt/

**Definition**: to put something into effect.
...
### Inequalities *[Noun]* — /ˈɪniˈkwɑɫɪtiz/

**Definition**: the quality of being unequal or uneven.
...
### Initiative *[Noun]* — /ˌɪˈnɪʃətɪv/

**Definition**: a new plan or process to deal with something, such as a problem.
...
### In advance *[Expression]* *(collocation)* — /ˈɪn/ /ədˈvɑ:ns/
...
### Intimidating *[Adjective]* — /ˌɪnˈtɪmɪˌdeɪtɪŋ/

**Definition**: making you feel nervous, less confident, or frightened.
