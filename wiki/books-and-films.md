...
**Summary**: Vocabulary for the IELTS 'Books and Films' topic, extracted from pages 83-90 of the source book.
...
- **Nouns** (21): `Moviegoer`, `Sci-fi = science fiction`, `Trailer`, `Plot`, `Venue`, `Gig`, `Sitcom`, `Cinemagoer = moviegoer`, `Reference book`, `Bedtime story`, `Blockbuster`, `Action movie = Kung Fu film`, `Animated film`, `Horror films`, `Subtitle`, `A feast for the eyes and ears`, `Censorship`, `Box office hit`, `E-reader`, `Hardcover`, `Page turner`
- **Verbs** (6): `(To) grasp`, `Broaden one's knowledge`, `Release`, `To catch the latest movie`, `To flick through`, `To know like a book`
- **Adjectives** (14): `Spectacular`, `Suitable for`, `Fascinating`, `Frustrated`, `Curious`, `Enthralling`, `Poetic`, `Action-packed`, `Addictive`, `Creepy`, `Dreary`, `Heartbreaking`, `Inspirational`, `Tear-jerking`
- **Expressions** (6): `(To) come highly recommended`, `(To) stick in one's mind`, `Keep one's eyes glued to screens`, `By leaps and bounds`, `From cover to cover`, `Don't judge a book by its cover`
