...
**Summary**: Vocabulary for the IELTS 'Travel, Tourism & Holidays' topic, extracted from pages 123-146 of the source book.
...
- **Nouns** (62): `Scenery`, `Rays`, `Ferry`, `Mainland`, `Scenery`, `Sandcastle`, `Full moon`, `Campfire`, `A riot of colour`, `Flowerbed`, `A leisurely stroll`, `Wonderland`, `Impression`, `Favorable conditions`, `Golden opportunity`, `Breeze`, `Dawn`, `Vacation`, `Holiday`, `Frame of mind`, `Company`, `Tranquility`, `Glory`, `Relic`, `Impression`, `Hospitality`, `Relics of the past`, `Nostalgia`, `Backpackers`, `The holiday of a lifetime`, `Ethnic groups`, `Destination resorts`, `No-stopping zones = No parking areas`, `Slum`, `Historical places`, `Local inhabitants`, `A thing of the past`, `Glamour`, `Influx`, `Budget airline`, `Cuisine`, `Tourist attraction`, `Historic site`, `Barbecue`, `Buffet`, `Picnic`, `Snack`, `Ready meal`, `Charter flight`, `Far-off destination`, `Guided tour`, `Holiday brochure`, `Holiday destination`, `Hordes of tourists`, `Package tour`, `Picturesque village`, `Places of interest`, `Tourist trap`, `Wildlife safari`, `Youth hostel`, `Means of transport`, `Tourist`
- **Verbs** (19): `Show someone around`, `Take place`, `Stretch`, `Attract more visitors`, `Show up`, `Check into`, `Fall away`, `To twinkle`, `To feel at peace`, `Jump at the chance`, `Inspire`, `(To) charm`, `(To) cater for`, `To broaden one's literary horizons`, `Drop off`, `Pick up`, `Overcharge`, `To book (something)`, `Head for`
- **Adjectives** (43): `Impressed`, `Picturesque`, `Breathtaking`, `Crystal clear`, `Unforgettable`, `Striking`, `Unique`, `Pleasant`, `A myriad of`, `Stimulating`, `Therapeutic`, `Exhilarating`, `Invigorating`, `Invaluable`, `Breath-taking`, `Hectic`, `Valuable`, `Enchanting`, `Appealing`, `Renowned`, `Ample`, `Spacious`, `Monotonous`, `Dreary`, `Rowdy`, `Far-flung`, `Exotic`, `Costly`, `Luxury`, `Gigantic`, `Immense`, `Essential`, `Incredible`, `Refreshing`, `All-inclusive`, `Half-board`, `Full-board`, `Self-catering`, `Remote`, `Coastal`, `Mountainous`, `Rural`, `Urban`
- **Adverbs** (5): `Overseas`, `Endlessly`, `Avidly`, `Immensely`, `In the middle of nowhere`
- **Expressions** (13): `From/ Out of nowhere`, `Give someone a lift`, `Drop someone off`, `Get familiar with`, `Out of this world`, `To be thronged with tourists`, `To get away from it all`, `Remote corners of the world`, `Draw inspiration from`, `Pay a visit`, `Getting away from it all`, `Go off the beaten track`, `Out of season`

---

## Entries

### Show someone around *[Verb]* *(collocation)*
...
**Definition**: beautiful nature scenes/landscapes.
...
**Definition**: narrow beams of light.
...
### From/ Out of nowhere *[Expression]* *(collocation)*
...
**Definition**: to have a good feeling on something because it is interesting or beautiful.
...
**Definition**: attractive or pretty in appearance (of a place, building, scene, etc.).
...
**Definition**: a boat or ship that carries people, vehicles or goods across an area of water (a river or a short journey by sea).
...
**Definition**: the main area of land of a country, region, etc.
...
**Definition**: the beautiful natural features of a place or area, such as mountains, forests, seas, rivers, etc.
...
**Definition**: to or in another country, especially one beyond or across the sea; abroad.
...
**Definition**: very beautiful, exciting or impressive.
...
### Crystal clear *[Adjective]* *(collocation)*
...
**Definition**: to extend in length of land or sea.
...
**Definition**: seems to have no end or limit.
...
### Attract more visitors *[Verb]* *(collocation)*
...
### To feel at peace *[Verb]* *(collocation)*
...
**Definition**: if something is unforgettable, you can't forget it.

- The trip to our countryside was unforgettable.
- My first-time scuba diving was unforgettable.

### Jump at the chance *[Verb]* *(collocation)*
...
### A riot of colour *[Noun]* *(collocation)*
...
**Definition**: very attractive and unusual.

- It was a striking outfit which made her feel good.

### Flowerbed *[Noun]*

**Definition**: a piece of a garden in which flowers are planted.

- His dog came into my garden this morning and buried a bone in my flowerbed.

### A leisurely stroll *[Noun]* *(collocation)*
...
**Definition**: showing great interest or enthusiasm in.
...
**Definition**: an imaginary place in children's stories which is full of wonderful things.
...
**Definition**: very special and unlike anything else.
...
### Give someone a lift *[Expression]* *(collocation)*
...
### Drop someone off *[Expression]* *(collocation)*
...
**Definition**: feeling or feelings about something.
...
### Favorable conditions *[Noun]* *(collocation)*
...
**Definition**: describing something that inspires new ideas or enthusiasm.

- I had a very stimulating conversation with Mary.
- Aerobics is one of the most stimulating forms of exercise.

### Golden opportunity *[Noun]* *(collocation)*
...
**Definition**: a very soft and gently wind.
...
**Definition**: the very early time in the morning when sunlight first begins to appear.
...
**Definition**: making someone more relaxed or happier.

- Meditation can be very therapeutic in helping people to reduce their stress.

### Inspire *[Verb]*

**Definition**: to make someone feel excited or interested in doing something.
...
**Definition**: a period of time when a person travels to another place to relax and enjoy himself/herself.
...
**Definition**: a period of time you are off from work to go on a trip for relaxation.

- He seems very tired at the moment. He needs a holiday.
- We are going on holiday next week.

### Frame of mind *[Noun]* *(collocation)*
...
**Definition**: making someone feel extremely happy and excited.
...
**Definition**: making someone feel excited, healthy and full of energy.
...
**Definition**: extremely beautiful in an impressive way.

- The beach is famous for its breath-taking views.
- What a breath-taking view!

### (To) charm *[Verb]* *(collocation)*
...
**Definition**: very charming or attractive.
...
**Definition**: the fact of being with a person or people.
...
**Definition**: famous for something.
...
**Definition**: the state of being quiet and peaceful.
...
**Definition**: large and with plenty of space.
...
**Definition**: great beauty.

- The glory of the town is its fountain.

### Relic *[Noun]*

**Definition**: an object surviving from the past that continues to exist.
...
**Definition**: dull, tedious, boring.
...
**Definition**: boring and making you feel sad or unhappy.
...
**Definition**: feeling or feelings about something or someone.
...
### Relics of the past *[Noun]* *(collocation)*
...
### Out of this world *[Expression]* *(collocation)*
...
- The coffee was out of this world, made by the gods (café farmers) of Colombia.
- His confidence was out of this world.

### Nostalgia *[Noun]*

**Definition**: a feeling of sadness mixed with pleasure and affection when you think about things that happened.
...
### To be thronged with tourists *[Expression]* *(collocation)*
...
**Definition**: people without much money, who travel on holiday carrying all their belongings in a backpack.

- They are backpackers.
- Most of the people here are backpackers.

### To get away from it all *[Expression]* *(collocation)*
...
### The holiday of a lifetime *[Noun]* *(collocation)*
...
### Ethnic groups *[Noun]* *(collocation)*
...
### Remote corners of the world *[Expression]* *(collocation)*
...
### Draw inspiration from *[Expression]* *(collocation)*
...
### Destination resorts *[Noun]* *(collocation)*
...
**Definition**: noisy, loud, disorder, rough.
...
### No-stopping zones = No parking areas *[Noun]* *(collocation)*
...
**Definition**: an area of a city where living conditions are very poor and the houses are in bad condition.

- I can't stand this slum any longer, tidy it up!
- The redevelopment of the slum area is well under way.

### Pay a visit *[Expression]* *(collocation)*
...
### Historical places *[Noun]* *(collocation)*
...
### Local inhabitants *[Noun]* *(collocation)*
...
### A thing of the past *[Noun]* *(collocation)*
...
**Definition**: beauty or charm that is sexually attractive and makes something or somebody seem special.
...
**Definition**: make somebody pay too much for something.
...
**Definition**: an arrival or entry into a place of large numbers of people or things.
...
**Definition**: something that is exciting and unusual because it is connected with a distant country.
...
**Definition**: vast; huge; to a very great extent.
...
**Definition**: something usually very expensive, beautiful or comfortable that you enjoy but do not really need.

- He lives in luxury.
- He owns three houses and four luxury cars.
- Taking a taxi is a luxury for her.

### Tourist attraction *[Noun]* *(collocation)*
...
### Historic site *[Noun]* *(collocation)*
...
**Definition**: vast; huge; extremely large in size, amount, or degree.
...
**Definition**: surprising, or impossible to believe.
...
**Definition**: making someone feel more lively when they have been feeling hot or tired.
...
**Definition**: a meal or party at which meat and other food are cooked and eaten outside.
...
**Definition**: a meal at which people serve themselves by going and choosing different types of food.
...
**Definition**: a meal eaten outside, especially in the countryside as part of an excursion.
...
**Definition**: including all the costs, charges, and services of accommodation, meals and drinks.
...
### Half-board *[Adjective]*

**Definition**: a hotel rate that includes accommodation, breakfast and dinner, but not lunch.
...
### Full-board *[Adjective]*

**Definition**: the services that you get at a hotel including all your meals there.
...
**Definition**: a holiday deal where you can cook your own food (meals are not provided).

- Tom thinks that self-catering is neither pleasant nor efficient.

### To book (something) *[Verb]* *(collocation)*
...
### Charter flight *[Noun]* *(collocation)*
...
### Far-off destination *[Noun]* *(collocation)*
...
### Getting away from it all *[Expression]* *(collocation)*
...
### Go off the beaten track *[Expression]* *(collocation)*
...
### Holiday brochure *[Noun]* *(collocation)*
...
### Holiday destination *[Noun]* *(collocation)*
...
### Hordes of tourists *[Noun]* *(collocation)*
...
### In the middle of nowhere *[Adverb]* *(collocation)*
...
### Out of season *[Expression]* *(collocation)*
...
### Picturesque village *[Noun]* *(collocation)*
...
### Places of interest *[Noun]* *(collocation)*
...
### Wildlife safari *[Noun]* *(collocation)*
...
**Definition**: far away from places where most people live.
...
**Definition**: on land beside a sea (the land near a shore).
...
**Definition**: covered with mountains; having a lot of mountains.
...
**Definition**: relating to the countryside, far away from large towns or cities.
...
### Means of transport *[Noun]* *(collocation)*
...
**Definition**: someone who is visiting a place for pleasure on holiday.

- In the summer, the museum is filled with tourists.
- Our city attracts a lot of tourists every day.
- Go skiing/ skating/ fishing/ trekking (go + … ing) I used to go skiing in the winter.
