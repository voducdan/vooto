# Letter N (Alphabetical Vocabulary)

**Summary**: Alphabetical vocabulary entries starting with 'N', from the 'Other Vocabularies' section (pages 296-297).
...
- **Nouns** (7): `Novelist`, `The needy`, `Night lamp = night light`, `The naked eye`, `Notable drawbacks`, `Negative factor`, `Novelty`
- **Verbs** (2): `Nominate`, `Neglected`
- **Adjectives** (2): `Nerve-racking`, `Needy`
