...
**Summary**: Vocabulary for the IELTS 'Friends' topic, extracted from pages 166-170 of the source book.
...
- **Nouns** (8): `Close friends`, `Mutual friend`, `Compliment`, `Sound advice`, `Circle of virtual friends`, `Fair-weather friend`, `Best friend`, `Soul mate`
- **Verbs** (3): `To create a strong bond`, `Care about`, `Console`
- **Adjectives** (1): `To be well-matched`
- **Expressions** (12): `Get on with`, `Enjoy each other's company`, `Get in touch with somebody`, `Near and dear to someone`, `Shoulder to cry on`, `To be through thick and thin`, `To fall for someone (to fall in love with someone)`, `To get on like a house on fire`, `To get to know someone`, `To have a lot in common`, `To hit it off with somebody`, `To lose touch with someone`
