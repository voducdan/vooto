...
**Summary**: Vocabulary for the IELTS 'The Media' topic, extracted from pages 80-82 of the source book.
...
- **Nouns** (9): `Episode`, `Mass media`, `Online scams = Internet fraud`, `Breaking news`, `Commercial advertising`, `Live broadcast`, `Classified ads`, `Domestic news`, `Publication`
- **Adjectives** (3): `Periodical`, `Entertaining`, `Informative`
- **Expressions** (1): `To keep abreast of something`
...
**Definition**: a separate part of shows or television series.

- Each episode of that TV drama ends with somebody delivering a profound line.
- I have watched every episode of the series he has appeared in.

### Mass media *[Noun]* *(collocation)*
...
### Online scams = Internet fraud *[Noun]* *(collocation)*
...
### Breaking news *[Noun]* *(collocation)*
...
### Commercial advertising *[Noun]* *(collocation)*
...
### Live broadcast *[Noun]* *(collocation)*
...
### Classified ads *[Noun]* *(collocation)*
...
**Definition**: a magazine or newspaper on a particular subject that is published regularly.

- She made periodical visits to her dentist.
- A periodical town newsletter that is supported by local advertisers.

### Domestic news *[Noun]* *(collocation)*
...
### To keep abreast of something *[Expression]* *(collocation)*
...
**Definition**: amusing, funny and enjoyable.
...
**Definition**: the process of producing a book, magazine, journal, piece of music, etc for public sale.
