...
**Summary**: Vocabulary for the IELTS 'IELTS Writing Vocabulary' topic, extracted from pages 245-251 of the source book.
...
- **Nouns** (4): `Fluctuations`, `Figure`, `Expenditure = spending`, `Fuel`
- **Verbs** (7): `To peak`, `Forecast`, `Estimate`, `Anticipated`, `Overtaking`, `Vanished`, `Cut down`
- **Adjectives** (3): `Double`, `Stable`, `Steady`
- **Adverbs** (7): `Overall = general`, `Significantly`, `Steadily`, `Consistently`, `Sharply`, `By contrast/ In contrast`, `Slightly`
- **Expressions** (6): `Tended to increase`, `Reach a peak`, `Come a close second`, `In terms of`, `Account for`, `In preference to`
- **Conjunctions** (2): `Whereas = in contrast`, `While = whereas`

---

## Entries

### Overall = general *[Adverb]* *(collocation)* — /ˈoʊvɝˌɔɫ/ /ʤenər(ə)l/
...
### Fluctuations *[Noun]* — /ˌfɫəktʃuˈeɪʃənz/

**Definition**: changes in number or amount; a variation.

- Despite some minor fluctuations, this figure rose from about 15% in 2000 to 25% in 2010.

### Significantly *[Adverb]* — /sigˈnifikəntli/

**Definition**: in a large or important way to be worthy of attention.
...
### Steadily *[Adverb]* — /stedili/

**Definition**: in an even and regular way.
...
### Consistently *[Adverb]* — /kənˈsɪstəntɫi/

**Definition**: always in the same way.

- Overall, it is clear that the figures for all four indicators were consistently higher in Canada and Japan.

### Sharply *[Adverb]* — /ʃɑrpli/

**Definition**: quickly, suddenly and by a large amount.

- Prices rose sharply for fresh fruits and vegetables, particularly after 1989.
- The money spent on books rose sharply from $40 million in 2001 to $72 million in 2005.
...
### By contrast/ In contrast *[Adverb]* *(collocation)* — /bai/ /kənˈtræst/ /ˈɪn/ /kənˈtræst/
...
**Definition**: a number representing a particular amount.
...
### Slightly *[Adverb]* — /slaitli/

**Definition**: a little; not considerably.
...
### Tended to increase *[Expression]* *(collocation)* — /ˈtɛndɪd/ /ˈtu/ /inˈkri:s/
...
### Reach a peak *[Expression]* *(collocation)* — /ri:tʃ/ /ˈeɪ/ /pi:k/
...
### To peak *[Verb]* *(collocation)* — /ˈtu/ /pi:k/
...
### Expenditure = spending *[Noun]* *(collocation)* — /ɪkˈspɛndətʃɝ/ /ˈspɛndɪŋ/
...
### Come a close second *[Expression]* *(collocation)* — /kʌm/ /ˈeɪ/ /klouz/ /ˈsɛkənd/
...
### Double *[Adjective]* — /dʌbl/

**Definition**: to twice the number or amount of something.
...
### Whereas = in contrast *[Conjunction]* *(collocation)* — /weəˈræz/ /ˈɪn/ /kənˈtræst/
...
### In terms of *[Expression]* *(collocation)* — /ˈɪn/ /ˈtɝmz/ /ɔv/
...
### Account for *[Expression]* *(collocation)* — /əˈkaunt/ /fɔ:/
...
**Definition**: a material that produces energy, power or heat when you burn it.
...
### While = whereas *[Conjunction]* *(collocation)* — /wail/ /weəˈræz/
...
### Forecast *[Verb]* — /fɔ:ˈkɑ:st/

**Definition**: to predict or estimate (a future event or trend) based on the information that you have now.
...
**Definition**: not likely to change, remaining constant; firmly fixed.
...
### In preference to *[Expression]* *(collocation)* — /ˈɪn/ /prefərəns/ /ˈtu/
...
**Definition**: roughly/approximately calculate without knowing the number exactly.
...
### Anticipated *[Verb]* — /ænˈtɪsəˌpeɪtɪd/

**Definition**: expected; estimated.
...
### Overtaking *[Verb]* — /ˈoʊvɝˌteɪkɪŋ/

**Definition**: become greater in number, or amount than something else.
...
### Steady *[Adjective]* — /stedi/

**Definition**: not changing; firmly fixed.
...
### Cut down *[Verb]* *(collocation)* — /kʌt/ /daun/
