...
**Summary**: Vocabulary for the IELTS 'Towns and Cities' topic, extracted from pages 171-176 of the source book.
...
- **Nouns** (23): `Cosmopolitan`, `Population`, `Specialty`, `Cost of living`, `City dwellers`, `Air quality`, `Nightlife`, `Holiday resort (tourist resort)`, `Seaside resort`, `Spare time`, `Check-in desk`, `Destination`, `Travel agency`, `Tour guide`, `Package holiday`, `Campsite`, `Cafeteria`, `Maid`, `Guesthouse`, `Neighborhood`, `Studio flat`, `Leisure centre`, `Exercise machines`
- **Verbs** (7): `Situated`, `Be crazy about`, `Sunbathe`, `Get a suntan`, `Hitchhike`, `Set off`, `Furnished`
- **Adjectives** (3): `Vibrant`, `Dynamic`, `Homey`
- **Adverbs** (1): `Adjacent`
- **Expressions** (2): `In good condition`, `Clean and tidy`
