# Letter R (Alphabetical Vocabulary)
...
- **Nouns** (7): `Rival`, `Resourcefulness`, `Refuge`, `Respiratory disorder`, `Realization`, `Rivalry`, `Reluctance`
- **Verbs** (8): `Remind of`, `Reckon`, `Recount`, `Regret`, `To rest`, `Review`, `Reinforce`, `To read over`
- **Adjectives** (4): `Reluctant`, `Removable`, `Rebellious`, `Repetitive`
- **Adverbs** (1): `Roughly`
- **Expressions** (1): `Run into difficulties`
...
### Run into difficulties *[Expression]* *(collocation)*
...
### Respiratory disorder *[Noun]* *(collocation)*
