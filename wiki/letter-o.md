# Letter O (Alphabetical Vocabulary)

**Summary**: Alphabetical vocabulary entries starting with 'O', from the 'Other Vocabularies' section (pages 298-299).
...
- **Nouns** (2): `Obstacle`, `Overload`
- **Verbs** (3): `Overlook`, `Outweighed`, `Opt for`
- **Adjectives** (3): `Open to`, `Outdated`, `To be overprotective`
- **Expressions** (2): `On purpose`, `Out of the question`
