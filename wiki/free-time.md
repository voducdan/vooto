...
**Summary**: Vocabulary for the IELTS 'Free Time / Hobbies / Interest' topic, extracted from pages 68-79 of the source book.
...
- **Nouns** (11): `Rock climbing`, `Hiking`, `Talent`, `Daily routine`, `Routine`, `Laziness`, `Amusement park = a theme park = funfair`, `Slot machine`, `Roller coaster`, `Pottery`, `Knitting`
- **Verbs** (22): `Take a nap = have a nap`, `Relax`, `To set aside some time`, `Take up`, `Take part`, `(To) have a stroll`, `Give up`, `Pursue one's passions`, `Adopt the habit`, `Drop in`, `Hang out`, `Take it easy`, `Put off`, `Give up`, `Have a good command of`, `Do a good deed`, `Go sightseeing`, `Pursue a goal`, `Share a common interest`, `To embark on`, `Lost the habit`, `To mow the lawn`
- **Adjectives** (9): `Do-It-Yourself`, `Fast-paced`, `Sedentary`, `Flexible`, `Intriguing`, `Adventurous`, `Absorbed in`, `Pleasurable`, `Enjoyable`
- **Adverbs** (14): `Tend to`, `Barely`, `Every so often = from time to time`, `As a rule`, `Frequently`, `Rarely = seldom`, `For ages`, `On a daily basis`, `Regular`, `Every so often`, `Once in a blue moon`, `Used to`, `All year round`, `Have a whale of time`
- **Expressions** (15): `Be in the mood`, `On cloud 9`, `Take an interest in`, `To one's liking`, `Get into the habit of`, `On a regular basis`, `Be passionate about`, `Stay up late`, `Keep up with`, `Be more likely to`, `Get into the habit of`, `Get accustomed to`, `Take advantage of`, `When it comes to`, `In favor of`

---

## Entries

### Take a nap = have a nap *[Verb]* *(collocation)*
...
**Definition**: to take it easy; to calm down; to release tension and anxiety.

- I like to take a bath to relax after a hard day at work.
- People in the 21st century worked hard and didn't have time to relax.

### To set aside some time *[Verb]* *(collocation)*
...
### Be in the mood *[Expression]* *(collocation)*
...
### (To) have a stroll *[Verb]* *(collocation)*
...
### Rock climbing *[Noun]* *(collocation)*
...
**Definition**: the activity of going on long walks in the countryside, usually for pleasure or exercise.
...
**Definition**: also known as DIY, the activity of doing or making something without any support or assistance.
...
**Definition**: moving or happening very quickly; very busy.
...
### On cloud 9 *[Expression]* *(collocation)*
...
**Definition**: (of a person) tending to spend a lot of time sitting down and little physical exercise.
...
### Every so often = from time to time *[Adverb]* *(collocation)*
...
**Definition**: a special ability or skill that someone has.
...
### Pursue one's passions *[Verb]* *(collocation)*
...
### Rarely = seldom *[Adverb]* *(collocation)*
...
### Adopt the habit *[Verb]* *(collocation)*
...
### Take an interest in *[Expression]* *(collocation)*
...
### Get into the habit of *[Expression]* *(collocation)*
...
### Have a good command of *[Verb]* *(collocation)*
...
### Do a good deed *[Verb]* *(collocation)*
...
### On a regular basis *[Expression]* *(collocation)*
...
### Go sightseeing *[Verb]* *(collocation)*
...
### Stay up late *[Expression]* *(collocation)*
...
### Keep up with *[Expression]* *(collocation)*
...
### Pursue a goal *[Verb]* *(collocation)*
...
### Share a common interest *[Verb]* *(collocation)*
...
### On a daily basis *[Adverb]* *(collocation)*
...
### Be more likely to *[Expression]* *(collocation)*
...
### Get accustomed to *[Expression]* *(collocation)*
...
### Take advantage of *[Expression]* *(collocation)*
...
### When it comes to *[Expression]* *(collocation)*
...
**Definition**: a number of actions someone normally does as a habit.
...
### Every so often *[Adverb]* *(collocation)*
...
### Once in a blue moon *[Adverb]* *(collocation)*
...
### All year round *[Adverb]* *(collocation)*
...
**Definition**: willing to take risks and try new methods, or experiences.

- Our cat is not very adventurous, so she rarely goes outside.
- Adam is an adventurous young man.

### Have a whale of time *[Adverb]* *(collocation)*
...
### Absorbed in *[Adjective]* *(collocation)*
...
### Lost the habit *[Verb]* *(collocation)*
...
**Definition**: the quality of being unwilling to be active (do not want to work or make any effort).
...
### Amusement park = a theme park = funfair *[Noun]* *(collocation)*
...
### Roller coaster *[Noun]* *(collocation)*
...
**Definition**: vase, pots, cups, plates etc. that are made out of clay and baked in an oven.
...
**Definition**: the activity of knitting things, such as sweaters, gloves, scarves etc.

- She loves knitting and working with fabrics.
- She spent many days knitting a sweater for him.

### To mow the lawn *[Verb]* *(collocation)*
