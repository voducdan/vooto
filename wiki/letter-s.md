# Letter S (Alphabetical Vocabulary)
...
- **Nouns** (13): `Sponsor`, `Stuffed bear`, `The shore`, `Sensitivity`, `Storytelling`, `Setback`, `Spot`, `Souvenir`, `Social isolation`, `Sex discrimination`, `Sound reasons`, `Self-interest`, `Sanity`
- **Verbs** (15): `Sink in`, `Simplify`, `To stem from`, `(To) surround`, `To seat`, `To stand out`, `To stem from`, `Spread throughout`, `Set to`, `Sustain`, `Settle`, `Subsidise`, `Sited`, `Speed up`, `Shrink`
- **Adjectives** (8): `Superb`, `Substandard`, `Self-explanatory`, `Sustainable`, `Suited`, `Serviceable`, `Sophisticated`, `Sweaty`
- **Adverbs** (4): `Sparingly`, `Sparingly`, `Scrupulously`, `Stressed out`
- **Expressions** (8): `To some degree`, `To squander a chance/an opportunity`, `To sift information`, `To strike somebody as`, `Secure in the knowledge`, `Second to none`, `Suit someone down to the ground`, `To strike up (a conversation, a relationship)`

---

## Entries

### Sink in *[Verb]* *(collocation)* — /sɪŋk/ /ˈɪn/
...
### Stuffed bear *[Noun]* *(collocation)* — /ˈstəft/ /beə/
...
### The shore *[Noun]* *(collocation)* — /ˈðə/ /ˈʃɔɹ/
...
### To some degree *[Expression]* *(collocation)* — /ˈtu/ /sʌm/ /dɪˈgri:/
...
### Storytelling *[Noun]* — /ˈstɔɹiˌtɛɫɪŋ/
...
### To stem from *[Verb]* *(collocation)* — /ˈtu/ /ˈstɛm/ /frɔm/
...
### (To) surround *[Verb]* *(collocation)* — /ˈtu/ /sәˈraƱnd/
...
### To squander a chance/an opportunity *[Expression]* *(collocation)* — /ˈtu/ /ˈskwɑndɝ/ /ˈeɪ/ /ˈtʃæns/ /ˈæn/ /ˌɒpərˈtyunɪti/
...
### Substandard *[Adjective]* — /səbˈstændɝd/
...
### To sift information *[Expression]* *(collocation)* — /ˈtu/ /ˈsɪft/ /
...
### To strike somebody as *[Expression]* *(collocation)* — /ˈtu/ /straik/ /ˈsəmˌbɑdi/ /ˈæz/
...
### Self-explanatory *[Adjective]* — /ˈsɛɫf/ /ɪksˈpɫænəˌtɔɹi/
...
### Secure in the knowledge *[Expression]* *(collocation)* — /siˈkjuə/ /ˈɪn/ /ˈðə/ /nɒliʤ/
...
### Second to none *[Expression]* *(collocation)* — /ˈsɛkənd/ /ˈtu/ /nʌn/
...
### Suit someone down to the ground *[Expression]* *(collocation)* — /su:t/ /ˈsəmˌwən/ /daun/ /ˈtu/ /ˈðə/ /graund/
...
### To seat *[Verb]* *(collocation)* — /ˈtu/ /si:t/
...
### To stand out *[Verb]* *(collocation)* — /ˈtu/ /stænd/ /ˈaʊt/
...
### Social isolation *[Noun]* *(collocation)* — /souʃl/ /ˌaɪsəˈɫeɪʃən/
...
### Spread throughout *[Verb]* *(collocation)* — /spred/ /θru:ˈaut/
...
### Set to *[Verb]* *(collocation)* — /ˈsɛt/ /ˈtu/
...
### Sex discrimination *[Noun]* *(collocation)* — /seks/ /dɪsˌkɹɪməˈneɪʃən/
...
### Sustainable *[Adjective]* — /səˈsteɪnəbəɫ/
...
### Speed up *[Verb]* *(collocation)* — /spi:d/ /Λp/
...
### Serviceable *[Adjective]* — /ˈsɝvəsəbəɫ/
...
### Sound reasons *[Noun]* *(collocation)* — /ˈsaʊnd/ /ˈɹizənz/
...
### Self-interest *[Noun]* — /ˈsɛɫˈfɪntɹəst/
...
### Scrupulously *[Adverb]* — /ˈskɹupjəɫəsɫi/
...
### Sophisticated *[Adjective]* — /səˈfɪstəˌkeɪtɪd/
...
### Stressed out *[Adverb]* *(collocation)* — /strest/ /ˈaʊt/
...
### To strike up (a conversation, a relationship) *[Expression]* *(collocation)* — /ˈtu/ /straik/ /Λp/ /ˈeɪ/ / /ˈeɪ/ /riˈleiʃәnʃip/
