...
**Summary**: Vocabulary for the IELTS 'Health / Keeping Fit' topic, extracted from pages 49-67 of the source book.
...
- **Nouns** (51): `Ageing`, `Awareness`, `Sanitation`, `Immune system`, `A fitness regime`, `Remedy`, `Strain`, `Check-ups`, `Longevity`, `Extreme sports`, `Jogging`, `A sedentary lifestyle`, `A team player`, `Thoroughness`, `Lifestyle`, `Physical fitness`, `Stamina`, `Flexibility`, `Meditation`, `Well-being`, `A sports fan`, `Mental health problem`, `Chronic illness = chronic disease`, `Diabetes`, `Obesity`, `Vaccines`, `Basic necessities`, `Sufferings`, `Voluntary activities`, `Football fan`, `Football season`, `Sports centre (fitness centre)`, `Sports facilities`, `Champion`, `Nutrients`, `Health benefits`, `Health problems`, `Allergy`, `Infection`, `Sedentary lifestyle`, `Nervous breakdown`, `Plastic surgery`, `Sick leave`, `Common cold`, `Cancer`, `Childhood diseases`, `Addict`, `A check-up`, `A runny nose`, `Chronic disease`, `Painkillers`
- **Verbs** (32): `Refresh`, `Boost someone's immune system`, `Suffer`, `Fit`, `Detoxify`, `Build up`, `Soothe one's soul`, `Look after`, `To remedy`, `Take care of`, `Relieve pressure on`, `Pass away`, `To exert oneself`, `Take up regular exercise`, `Do aerobics/ yoga`, `Have a go`, `Alleviate`, `To flourish`, `To provide someone with a healthy diet`, `(To) endure`, `To keep fit`, `Energize`, `To take regular exercise`, `To take gentle exercise`, `To build muscle`, `To warm up`, `Maintain`, `Cut down on`, `To diagnose`, `To stutter`, `To break a habit`, `To black out`
- **Adjectives** (18): `Energetic`, `Healthy`, `Antioxidant`, `Respiratory`, `Life-threatening`, `Fatal`, `To be detrimental to health`, `Exhausted`, `Seasick`, `Detrimental`, `Adverse`, `Pose potential health risks`, `To be addicted to`, `Obese`, `Mature`, `Overweight`, `Vulnerable`, `Alive and kicking`
- **Expressions** (13): `Be out of condition`, `Get into shape`, `On safety grounds`, `To take up sport`, `In good shape`, `Burn a lot of calories`, `To work out at the gym`, `In good health`, `In poor health`, `To be under the weather`, `To phone in sick`, `Sick as a dog = to be at death's door`, `White as a sheet`
...
**Definition**: to make someone less tired or hot.
...
**Definition**: to be full of energy.

- He isn't as energetic as he once was.
- He seemed a dynamic and energetic leader.

### Boost someone's immune system *[Verb]* *(collocation)*
...
**Definition**: to experience physical or mental pain (a disease, pain, sadness, etc.).
...
**Definition**: the process of becoming older and less healthy.
...
**Definition**: the state of knowing and understanding that something is happening.

- The accident has raised the public's awareness of the importance of wearing a helmet.

### Fit *[Verb]*

**Definition**: to be the right shape or size for someone or something.
...
**Definition**: to be good for health.
...
**Definition**: the process of keeping places clean and healthy, especially by removing human waste.
...
**Definition**: a substance which inhibits oxidation and slows down the aging process.
...
**Definition**: relating to or connected with breathing.
...
### Soothe one's soul *[Verb]* *(collocation)*
...
**Definition**: be highly likely to cause death/ kill someone.
...
### To be detrimental to health *[Adjective]* *(collocation)*
...
### A fitness regime *[Noun]* *(collocation)*
...
**Definition**: to vomit or feel sick because of the movement of the ship or boat.
...
### Relieve pressure on *[Verb]* *(collocation)*
...
**Definition**: mental pressure or worry caused by a difficult situation.
...
**Definition**: negative, harmful, unfavourable and unpleasant.
...
### Pose potential health risks *[Adjective]* *(collocation)*
...
**Definition**: long life; living for a long time.

- I wish you longevity and good health.
- The dog has a longevity of about ten years.

### Be out of condition *[Expression]* *(collocation)*
...
### Get into shape *[Expression]* *(collocation)*
...
### On safety grounds *[Expression]* *(collocation)*

**Definition**: for reasons of safety.

- The building was closed on safety grounds.

### To exert oneself *[Verb]* *(collocation)*
...
### Take up regular exercise *[Verb]* *(collocation)*
...
### Extreme sports *[Noun]* *(collocation)*
...
### To be addicted to *[Adjective]* *(collocation)*
...
### A sedentary lifestyle *[Noun]* *(collocation)*
...
### A team player *[Noun]* *(collocation)*
...
**Definition**: the act of doing something very carefully and with great attention to detail.
...
### To take up sport *[Expression]* *(collocation)*
...
### Physical fitness *[Noun]* *(collocation)*
...
**Definition**: physical or mental strength that enables someone to sustain prolonged physical or mental effort.
...
### In good shape *[Expression]* *(collocation)*
...
### Burn a lot of calories *[Expression]* *(collocation)*
...
**Definition**: the ability to move and bend your body easily.
...
**Definition**: thinking deeply in silence, to make you feel calm.
...
**Definition**: health, happiness, and prosperity.
...
**Definition**: extremely fat or overweight (having excessive body fat).

- Obese people tend to find it very difficult to stop overeating.
- Being obese and lazy is dangerous to health.

### To provide someone with a healthy diet *[Verb]* *(collocation)*
...
**Definition**: fully grown (behaving like an adult).
...
### To work out at the gym *[Expression]* *(collocation)*
...
**Definition**: to make someone feel energetic or enthusiastic.

- We felt very energized after our holiday.
- I felt more energized after a bit of exercise.

### To take regular exercise *[Verb]* *(collocation)*
...
### Mental health problem *[Noun]* *(collocation)*
...
### To take gentle exercise *[Verb]* *(collocation)*
...
### Chronic illness = chronic disease *[Noun]* *(collocation)*
...
**Definition**: a chronic disease that affects your body's ability to produce a lot of urine and feel thirsty.
...
**Definition**: the fact of being very fat, in an unhealthy way.
...
**Definition**: substances that are put into the blood to prevent someone from getting the disease.

- Vaccines deliver antibodies that fight disease.
- Measles vaccines were given to all the children in the school.

### Basic necessities *[Noun]* *(collocation)*
...
**Definition**: the state of undergoing pain and unhappiness.
...
### Voluntary activities *[Noun]* *(collocation)*
...
### To build muscle *[Verb]* *(collocation)*
...
### Football season *[Noun]* *(collocation)*
...
### Sports centre (fitness centre) *[Noun]* *(collocation)*
...
### Sports facilities *[Noun]* *(collocation)*
...
**Definition**: someone who wins the first prize in a competition; a winner.
...
**Definition**: to take care of and make something stay the same.
...
**Definition**: a substance in food that provides nourishment essential for plants, animals, and people to live and grow.
...
**Definition**: excessive or extra weight (heavier than you should be).
...
### Health benefits *[Noun]* *(collocation)*
...
### Health problems *[Noun]* *(collocation)*
...
### In good health *[Expression]* *(collocation)*
...
### In poor health *[Expression]* *(collocation)*
...
**Definition**: a physical reaction to some specific food or substances.
...
**Definition**: a disease that is caused by bacteria or viruses.
...
### Nervous breakdown *[Noun]* *(collocation)*
...
### Plastic surgery *[Noun]* *(collocation)*
...
**Definition**: an extremely serious disease typically caused by a group of abnormal cells in a part of the body.

- Smoking can double the risk of lung cancer.
- Nearly 3.5 million cases of skin cancer are treated each year.

### Childhood diseases *[Noun]* *(collocation)*
...
**Definition**: a person who likes doing or using something, especially something harmful.

- He is a TV addict and watches as much as he can.
- Many young boys become computer addicts.

### A check-up *[Noun]* *(collocation)*
...
### Chronic disease *[Noun]* *(collocation)*
...
**Definition**: a type of medicine that relieves pain.
...
### To stutter *[Verb]* *(collocation)*

**Definition**: to talk the sounds of words over and over again in an uncontrolled way.

- He stutters sometimes when he's excited; He tended to stutter, which tried her patience.

### Alive and kicking *[Adjective]* *(collocation)*
...
### To break a habit *[Verb]* *(collocation)*
...
### To be under the weather *[Expression]* *(collocation)*
...
### To phone in sick *[Expression]* *(collocation)*
...
### Sick as a dog = to be at death's door *[Expression]* *(collocation)*
...
### White as a sheet *[Expression]* *(collocation)*
