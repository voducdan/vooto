# Letter M (Alphabetical Vocabulary)

**Summary**: Alphabetical vocabulary entries starting with 'M', from the 'Other Vocabularies' section (pages 293-295).
...
- **Nouns** (6): `Muscular development`, `Models`, `Majority`, `Maintenance`, `Mass`, `Mogul`
- **Verbs** (3): `Match`, `Mingle`, `(To) memorize`
- **Adjectives** (3): `Mindless`, `Mass-produced`, `Minor`
- **Adverbs** (2): `Mainly`, `To the full`
- **Expressions** (4): `Move out of`, `Means a lot to someone`, `Makes it possible`, `To make the grade`

---

## Entries

### Mainly *[Adverb]* — /ˈmeinli/
...
### Muscular development *[Noun]* *(collocation)* — /ˈməskjəɫɝ/ /di’velәpmәnt/
...
### To the full *[Adverb]* *(collocation)* — /ˈtu/ /ˈðə/ /ful/
...
**Definition**: to fit, be equal, or similar (colour, size or style).

- The words on his T-shirt doesn't match with him.
- This carpet does not match the curtain.

### Move out of *[Expression]* *(collocation)* — /mu:v/ /ˈaʊt/ /ɔv/
...
### Means a lot to someone *[Expression]* *(collocation)* — /mi:nz/ /ˈeɪ/ /ˈɫɑt/ /ˈtu/ /ˈsəmˌwən/
...
**Definition**: people whose job it is to wear and show new styles of clothes.

- Do women really want to look like fashion models?
- I think fashion models today are too thin.

### Makes it possible *[Expression]* *(collocation)* — /ˈmeɪks/ /ˈɪt/ /pɔsibəl/
...
**Definition**: to mix or combine something with something else.

- She felt a kind of happiness mingled with regret.
- Her essence is green mingled with blue.

### (To) memorize *[Verb]* *(collocation)* — /ˈtu/ /ˈmɛmɝˌaɪz/
...
### To make the grade *[Expression]* *(collocation)* — /ˈtu/ /meik/ /ˈðə/ /greɪd/
...
**Definition**: the process of preserving something.
...
### Mindless *[Adjective]* — /ˈmaɪndɫəs/

**Definition**: not requiring much mental effort (thought or intelligence).
...
### Mass-produced *[Adjective]* — /mæs/ /pɹəˈdust/

**Definition**: produced in large quantities, usually by machinery.
